...
class Disqus
{
    ...
    */
    public function get_html()
    {
        ...
        $disqus_js = BASE_URL('assets/vendor/disqus/embed.js');
        ...
        <script>
            ...
            */
            ...
            s.src = 'https://ngekos-web.disqus.com/embed.js';
            s.setAttribute('data-timestamp', +new Date());
            (d.head || d.body).appendChild(s);
            })();
        </script>
        <script id='dsq-count-scr' src='//ngekos-web.disqus.com/count.js' async></script>
        <noscript>
