		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="footer-right">
					...
					<ul>
						<li>
							<img class='bg-dark' src="<?= base_url('assets/img/icon/email.svg') ?>" alt="email">
							<a href="#">contact@ngekos.com</a>
						</li>
						<li>
							<img class='bg-dark p-1' src="<?= base_url('assets/img/icon/instagram.svg') ?>" alt="instagram">
							<a href="#">@ngekosapp</a>
						</li>
						<li>
							<img class='bg-dark p-1' src="<?= base_url('assets/img/icon/whatsapp.svg') ?>" alt="whatsapp">
